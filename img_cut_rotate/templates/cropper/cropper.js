let cropperUtil = require('./cropperUtil.js')
...
var init = function (W, H) {
    ...
    that.showCropper = (options) => {
		...
		let imageAgin = options.imageAgin;
...
//                     })
    ...
    that.cropImage = () => {
		...
		let imageAgin = this.data.imageAgin;
    ...
    that.drawLines = function (cropperMovableItems, imageInfo, callback) {
        ...
        if (mode == 'rectangle') {
            ...
            ctx.fillRect(0, 0, size.width, size.height - 10);
