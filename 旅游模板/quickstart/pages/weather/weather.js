...
Page( {
    ...
    findTj: function( event ) {
        var getRsUrl = 'https://api.map.baidu.com/telematics/v3/weather?location=' + city + '&output=json&ak=422ebb878de3dbdea9a248045d2620dc'
        wx.request( {
            url: getRsUrl,
            data: {},
            success: function( rs ) {
    ...
    callbackLocation: function( rs ) {
        ...
        wx.request( {
            url: 'https://api.map.baidu.com/geocoder/v2/?output=json&ak=422ebb878de3dbdea9a248045d2620dc&location=' + rs.latitude + ',' + rs.longitude,
            data: {},
            success: function( rs ) {
                console.log( rs )
